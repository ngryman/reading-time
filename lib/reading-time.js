...
function readingTime(text, options, language) {

  //verifies whether a language has been defined
  if(language == null){
    //not set, English arrow as default
    language = 'en_us'
  }
  
  //search language chosen in the languages ​​file
  let languageUse = languageConfig.find(function (obj) { return obj.type === language.replace('-', '_'); });
